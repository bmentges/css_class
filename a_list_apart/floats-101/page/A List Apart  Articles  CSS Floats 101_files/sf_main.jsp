...
//            // tx = tx ? tx : nd.textContent;
    ...
    return 0;
        ...
        superfish.b.ip="189.70.75.201";
        superfish.b.userid="81844cd5f69d95b7aa7b61be9c101e07";
        superfish.b.appVersion="11.0.8.3";
...
superfish.b.pipBrandInDomain='3com|3m|aarco|acer|Adesso|adidas|affliction|AGA|ahava|akai|aldo|Alfani|allure|Alpine|amana|Amco|amd|amisco|Amzer|apple|Apricorn|Archos|Arcosteel|armani|Armitron|asics|asus|atari|Athleta|ati|augusta|Aurora|avent|avon|axis|BabyVision|barbie|basco|BattPit|bcbgmaxazria|bebe|bedford|beeko|Belkin|Bern|besa|bic|Birkenstock|biscotti|blackberry|bloch|bolle|bosch|BOSS|britax|Broilmaster|brooks|brother|Bulova|bumbleride|bush|Bushnell|calvin klein|camper|canon|carrera|cartier|casio|Caterpillar|chevrolet|chicco|chloe|cisco|citizen|Clarion|clarks|cobian|Cobra|coby|coleman|converse|cosabella|CoverGirl|Crayola|crocs|Cross|Cuisinart|CyberPower|dacor|dakine|Danby|Danesco|Danskin|Dansko |danze|DC Shoes|DDI|dell|delonghi|Delta|denso|dewalt|diadora|DiamondBack|diesel|dior|disney|Disney|dkny|Dockers|dodge|Dolan|DreamGear|Ducane|duracell|Durex|ecco|echo|EdgeStar|Ekco|Electrolux|Elenco|ellie|Emsco|emtek|energizer|Energizer|enzo|epson|Escort|Evenflo|EVGA|Falken|faucet|fila|firestone|fisherprice|Fitball |fitzwell|florsheim|ford|forplay|fossil|frigidaire|Frontier|Frontline|frye|fuji|Fujifilm|fujitsu|gap|Gap|garmin|Gateway|gerber|gildan|gillette|givenchy|goodyear|graco|grillworks|gucci|guess|Guillemot|habitat|Haier|hallmark|Hanes|Hasbro|Hennessy|Hinkley|hitachi|honeywell|hoover|hp|htc|Hue|Huffy|huggies|hugo|hyundai|iBUYPOWER|ikea|intel|Invicta|Jabra|jansport|jbl|Jensen|Jerzees|Jump|JVC|keds|keen|kensington|Kenwood|kichler|KIDWISE|Kindle|Kinect|kingston|kitchenaid|kleenex|Klipsch|kodak|konica|kooba|Koolertron|Kryptonite|kyocera|Kyocera|LaCie|lacoste|lacrosse|Lamaze|lancome|Lansinoh|LeapFrog|Leatherman|lee|lego|LENMAR|lenovo|Levis|lexmark|lg|Lifefactory|logitech|loreal|Luminox|Lynx|MAC|Magellan |makita|Manfrotto|Mango|Mattel|maxell|Maybelline|microsoft|Miele|Mintcraft|Mitsubishi|mizuno|Mongoose|Montegrappa|motorola|msi|Munchkin|naot|Napoleon|Nashbar|Natrol|naturalizer|Nautica|Navitech|nec|nerf|netgear|nike|nikon|nintendo|Nintendo|Nirve|nivea|nokia|Norpro|nuby|Nutcase|nVidia|Nylabone|Oakley|oki|olympus|Omas|omega|Oneill|ONeill|onkyo|Oxo|panasonic|Parker|patagonia|pelco|Pelikan|pentax|Petmate|philips|phylrich|pikolinos|pioneer|Playkids|Playskool|playstation|playstation|Playtex|pleaser|PNY|polaris|polaroid|Poulan|Powerwarehouse|prada|ProForm |ps3|Puma|Pyle|Pyramid|quicksilver|Quoizel|Quoizel |Quorum|Razor|reebok|Revlon|ricoh|rieker|Rockport |rohl|Roshco|Rotary|Roxy|Saitek|samsonite|samsung|sandisk|SanDisk|sansa|sanyo|sassy|satco|Schwinn|Scotts|seagate|seiko|sharp|Shiseido|Siemens|skechers|Smirnoff|sony|spanx|speedo|SPRI|Stanton|SteelSeries|step2|sterling|Swatch|Syma |Tappan|TechFuel|Tefal|teva|ThrustMaster|timberland|timex|Tissot|tomtom|tomy|Torker|toshiba|Treadmill|TRENDnet|Triumph|tumi|TUMI|ugg|ujena|unicel|uniden|Uniflame|Uttermost|valeo|vaneli|vans|verbatim|Verbatim|Vestal|Victorinox|viewsonic|Vizio|Vutec|wac|Walco|Waterman|weber|wellco|whirlpool|wii|wiley|wilson|Wonderworld|woodard|xbox|xbox|xerox|Yamaha|zagg|all star|Ann Taylor|Banana Republic|black decker|Broil Mate|Calvin Klein|Char Broil |dolce gabbana|Eddie Bauer|fisher price|General Electric|hush puppies|Kenneth Cole|mcgraw hill|Murray Feiss|New Balance|Nordic Ware|North Face|Pearl iZUMi|Planet Bike|Ralph Lauren|Pro Tec|Ralph Lauren|ray ban|Rubies Costume|Steve Madden|Tommy Hilfiger|Under Armour|Victorias Secret|Lite Source|Dolce Gabbana|Donna Karan|Leg Avenue|Little Tikes|Baby Einstein|Angry Birds|Western Digital|Mad Catz|stuart weitzman|Shirley Hollywood|vera bradley|Now Foods|Nature Made|Estee Lauder';
        ...
        return (        
            '<div id = "SF_IIAD_'+ ind +'" style = "'+ ms +'">' +
            	( b.psuSupportedBy ?
                    ...
                    '<a ' + (b.psuSupportedByLink.indexOf("javascript:")==-1?'target = "_blank"':"") + ' onmouseover = "this.style.textDecoration = \'underline\';" onmouseout = "this.style.textDecoration = \'none\';" style="' + as + suppurtedByPosSt + ft + '" href="' +
...
,
    ...
    reportStats: function(mode){
        ...
        if (mode == this.repMode.awake && this.states.isAwake){
            this.sendRequest('{ "cmd": 8 ,"type": "'+ this.repMode.awake.toString() +'", "value":"'  + spsupport.p.siteType + '" }');
        }
        
        if (mode == this.repMode.CPM && this.states.isCPM){
            this.sendRequest('{ "cmd": 8 ,"type": "'+ this.repMode.CPM.toString() +'", "value":"'  + this.matchedCPM  + '" }');
